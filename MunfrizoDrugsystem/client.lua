  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(1392.3264160156,3605.9270019531,38.94193649292, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 51))then
          collect2 = true
          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
         exports['progressBars']:startUI(1000, "Fremstiller Kokain")
         Citizen.Wait(1000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(1392.3264160156,3605.9270019531,38.94193649292, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 44))then
          collect = true
          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
         exports['progressBars']:startUI(10000, "Fremstiller Kokain x10")
         Citizen.Wait(10000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(-1622.6534423828,-994.30645751953,7.6779065132141, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
        ...
        TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
         exports['progressBars']:startUI(1000, "Sælger Kokain")
         Citizen.Wait(1000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(-1622.6534423828,-994.30645751953,7.2779065132141 + 0.06, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 44))then
          ...
          loadAnimDict("mp_common")
        TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
         exports['progressBars']:startUI(10000, "Sælger Kokain x10")
         Citizen.Wait(10000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
...
---------------------------------------------------------------------------------------------------------------------------------------
      ...
      Citizen.CreateThread(function()
         ...
         if(IsControlJustReleased(1, 51))then
          collect2 = true
          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
         exports['progressBars']:startUI(700, "Høster Hamplade")
         Citizen.Wait(700)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(2432.9777832031,4969.4848632813,43.400890350342, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 51))then
          collect2 = true
          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
         exports['progressBars']:startUI(700, "Tørrer Hamplade")
         Citizen.Wait(700)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(2432.9777832031,4969.4848632813,43.400890350342, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 44))then
          collect = true
          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
         exports['progressBars']:startUI(7000, "Tørrer Hamplade x10")
         Citizen.Wait(7000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(225.25419616699,-1982.4621582031,19.746425628662, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 51))then
          loadAnimDict("mp_common")
          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
         exports['progressBars']:startUI(700, "Sælger Skunk")
         Citizen.Wait(700)
         ClearPedTasksImmediately(GetPlayerPed(-1))
  ...
  while true do 
    ...
    if GetDistanceBetweenCoords(225.25419616699,-1982.4621582031,19.746425628662, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
         ...
         if(IsControlJustReleased(1, 44))then
          ...
          loadAnimDict("mp_common")
          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
         exports['progressBars']:startUI(7000, "Sælger Skunk x10")
         Citizen.Wait(7000)
         ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          collect2 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(700, "Udvinder Syre")
                                                         Citizen.Wait(700)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                       ...
                                       if(IsControlJustReleased(1, 44))then
                                        collect = true
                                        TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                       exports['progressBars']:startUI(7000, "Udvinder Syre x10")
                                       Citizen.Wait(7000)
                                       ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(2356.5842285156,3131.6752929688,48.208595275879, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          collect2 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(700, "Fremstiller LSD")
                                                         Citizen.Wait(700)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(2356.5842285156,3131.6752929688,48.208595275879, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          collect = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(7000, "Fremstiller LSD x10")
                                                         Citizen.Wait(7000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(-1564.3973388672,-3235.8251953125,26.336153030396, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          ...
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(700, "Sælger LSD")
                                                         Citizen.Wait(700)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(-1564.3973388672,-3235.8251953125,26.336153030396, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          ...
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(7000, "Sælger LSD x10")
                                                         Citizen.Wait(7000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(3559.2905273438,3672.0979003906,28.12188911438, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          collect2 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Fremstiller NaOH")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(3559.2905273438,3672.0979003906,28.12188911438, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          collect = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(10000, "Fremstiller NaOH x10")
                                                         Citizen.Wait(10000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                                    ...
                                                                    while true do 
                                                                      ...
                                                                      if GetDistanceBetweenCoords(1092.9554443359,-3194.8947753906,-38.993473052979, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                                           ...
                                                                           if(IsControlJustReleased(1, 51))then
                                                                            collect2 = true
                                                                            TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                                           exports['progressBars']:startUI(1000, "Fremstiller Amfetamin")
                                                                           Citizen.Wait(1000)
                                                                           ClearPedTasksImmediately(GetPlayerPed(-1))
                                                                    ...
                                                                    while true do 
                                                                      ...
                                                                      if GetDistanceBetweenCoords(-2036.3176269531,-1033.9346923828,5.8823590278625, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                                           ...
                                                                           if(IsControlJustReleased(1, 51))then
                                                                            ...
                                                                            loadAnimDict("mp_common")
                                                                            TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                                           exports['progressBars']:startUI(1000, "Sælger Amfetamin")
                                                                           Citizen.Wait(1000)
                                                                           ClearPedTasksImmediately(GetPlayerPed(-1))
                                                                    ...
                                                                    while true do 
                                                                      ...
                                                                      if GetDistanceBetweenCoords(-2036.3176269531,-1033.9346923828,5.8823590278625, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                                           ...
                                                                           if(IsControlJustReleased(1, 44))then
                                                                            ...
                                                                            loadAnimDict("mp_common")
                                                                            TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                                           exports['progressBars']:startUI(10000, "Sælger Amfetamin x10")
                                                                           Citizen.Wait(10000)
                                                                           ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         exports['progressBars']:startUI(1000, "Høster Blomster")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                       ...
                                       if(IsControlJustReleased(1, 44))then
                                        collect = true
                                        TaskStartScenarioInPlace(PlayerPedId(), 'WORLD_HUMAN_GARDENER_PLANT', 0, true)
                                       exports['progressBars']:startUI(10000, "Høster Blomster x10")
                                       Citizen.Wait(10000)
                                       ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1443.0721435547,6332.310546875,23.981895446777, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          collect2 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Koger Blomster")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1443.0721435547,6332.310546875,23.981895446777, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          collect = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(10000, "Koger Blomster x10")
                                                         Citizen.Wait(10000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(-2.1932320594788,6653.5297851563,31.208330154419, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         exports['progressBars']:startUI(1000, "Snitter Blomster")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(-2.1932320594788,6653.5297851563,31.208330154419, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          ...
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(10000, "Snitter Blomster x10")
                                                         Citizen.Wait(10000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1296.9281005859,1453.1201171875,99.449394226074, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         exports['progressBars']:startUI(1000, "Afleverer Blomster")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1296.9281005859,1453.1201171875,99.449394226074, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          ...
                                                          loadAnimDict("mp_common")
                                                          TaskStartScenarioInPlace(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(10000, "Afleverer Blomster x10")
                                                         Citizen.Wait(10000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1122.6550292969,-3196.8559570313,-40.396881103516, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          collect2 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(1000, "Hvidvasker Penge")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1122.6550292969,-3196.8559570313,-40.396881103516, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 44))then
                                                          collect3 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(5000, "Hvidvasker Penge x5")
                                                         Citizen.Wait(5000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1122.6550292969,-3196.8559570313,-40.396881103516, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 23))then
                                                          collect4 = true
                                                          TaskStartScenarioInPlace(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(10000, "Hvidvasker Penge x10")
                                                         Citizen.Wait(10000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         exports['progressBars']:startUI(1000, "Udvinder Aluminium Oxide")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1087.8718261719,-2001.8940429688,30.87518119812, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Smelter Aluminium")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(107.78172302246,-934.28332519532,29.774265289306, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(1000, "Sælger Aluminium Bar")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'WORLD_HUMAN_CONST_DRILL', 0, true)
                                                         exports['progressBars']:startUI(1000, "Udvinder Guldmalm")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1085.0635986328,-2002.1551513672,31.429588317871, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Smelter Guldmalm")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(109.35730743408,-929.24609375,29.8268699646, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(1000, "Sælger Guld Bar")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'WORLD_HUMAN_CONST_DRILL', 0, true)
                                                         exports['progressBars']:startUI(1000, "Udvinder Stål")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1087.7242431641,-2004.9129638672,31.153045654297, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Smelter Stål")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(105.80088043213,-938.52996826172,29.736600875854, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(1000, "Sælger Rustfrit Stål")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'WORLD_HUMAN_CONST_DRILL', 0, true)
                                                         exports['progressBars']:startUI(1000, "Udvinder Kul")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                ...
                                                Citizen.CreateThread(function()
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(1109.9221191406,-2008.1363525391,31.058889389038, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          TaskStartScenarioInPlace(PlayerPedId(), 'PROP_HUMAN_PARKING_METER', 0, true)
                                                         exports['progressBars']:startUI(1000, "Kompresser Kul")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
                                                  ...
                                                  while true do 
                                                    ...
                                                    if GetDistanceBetweenCoords(-622.01745605468,-230.66743469238,38.057067871094, GetEntityCoords(GetPlayerPed(-1))) < 5.0 then
                                                         ...
                                                         if(IsControlJustReleased(1, 51))then
                                                          loadAnimDict("mp_common")
                                                          TaskPlayAnim(PlayerPedId(), "mp_common", "givetake1_a", 8.0, 8.0, -1, 1, 0, false, false, false)
                                                         exports['progressBars']:startUI(1000, "Sælger Diamant")
                                                         Citizen.Wait(1000)
                                                         ClearPedTasksImmediately(GetPlayerPed(-1))
